    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:Row(
          ...
          children: [
            Text("Medi ",style:TextStyle(color:Colors.black,fontSize:4.h,fontWeight: FontWeight.bold)),
            Text("Reminder",style:GoogleFonts.abel(color:Colors.green,fontSize:4.h,fontWeight: FontWeight.bold))
          ],
